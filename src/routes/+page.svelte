...
<div class="container h-full mx-auto flex justify-center lg:mt-20 mt-10">
	<div class="space-y-10 text-center flex flex-col items-center">
		<div class="max-w-xl">
			<h1 class="h1 mb-4">Experience the culinary journey of a lifetime at</h1>
			<figure class="mb-4">
				<img
					src="/images/logo.webp"
					alt="two Sisters logo"
					class="md:max-w-lg max-w-xs mr-auto ml-auto"
				/>
			</figure>
			<p class="h5">The premier destination for authentic Lao and Thai food in Canberra.</p>
			<Address />
		</div>
		...
		<section>
			<div class="max-w-[70vw] lg:max-w-[50vw] mr-auto ml-auto mb-16">
				<figure class="mt-4">
			...
			<div class="max-w-[70vw] lg:max-w-[50vw] mr-auto ml-auto mb-16">
				<h2 class="h2 mb-4">
					At Two Sisters, we believe in the power of fresh ingredients and time-honoured recipes.
				</h2>

				<p class="h3">
					Nestled in the vibrant heart of Dickson for over a quarter of a century, our family-run
					restaurant is a testament to the rich, traditional flavours of southern Laos and Thailand.
				</p>
			...
			Our menu is a culinary canvas showcasing an array of delectable dishes, from tantalising
			noodles and stir-fries to aromatic curries and other traditional delicacies. Each dish is
			meticulously crafted to ensure a flavourful explosion with every bite.
			<br />

			Whether you're in search of a quick yet satisfying lunch, planning a romantic dinner date, or
			arranging a lively family meal, Two Sisters is the perfect venue.
			<br />
			Our restaurant exudes a warm, vibrant, and welcoming atmosphere that caters to all dining occasions.
			Our dedicated team of professionals is committed to delivering exceptional service, ensuring that
			every visit becomes a memorable dining experience.
			<br />
			Indulge in the authentic taste of Thai food in Dickson at Two Sisters Lao Thai Cuisine.
		</section>
	</div>
</div>
